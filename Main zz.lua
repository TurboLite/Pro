...
textButton.AnchorPoint = Vector2.new() 
...
local Window = Fluent:CreateWindow({
    Title = "Turbo Lite Hub | Blox Fruit 21",
    SubTitle = "By YTB Turbo Lite",
    TabWidth = 110,
...
Tabs.Main:AddSection("Main Setup Farm")
Tabs.Main:AddButton({
                ...
                if game:GetService("Players").LocalPlayer.Data.Level.Value >= 800 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 0 then
                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Swan Pirates") and string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "50") and game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then 
                        if game:GetService("Workspace").Enemies:FindFirstChild("Swan Pirate") then
                            ...
                            repeat topos(CFrame.new(932.624451, 156.106079, 1180.27466, -0.973085582, 4.55137119e-08, -0.230443969, 2.67024713e-08, 1, 8.47491108e-08, 0.230443969, 7.63147128e-08, -0.973085582)) wait() until not _G.
...
spawn(function()
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Spam Boss Dough", Default = true})
...
if _G.ChestBypass then
 ...
 spawn(function()
    ...
    Tabs.Qs:AddSection("Farm Katakuri")
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Cày Vật Chất Kì Dì", Default = false })
    ...
    local Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Random Trái", Default = false })
...
game:GetService("TeleportService"):TeleportToPlaceInstance(game.placeId,_G.Job, game.Players.LocalPlayer)
    ...
    Tabs.Ms:AddButton({
		...
		local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Walk On Water", Default = true })
    Toggle:OnChanged(function(Value)
  _G.WalkWater = Value
		end)
