...
local ConCac = Tabs.Main:AddSection("Auto Ramdom Bone + Fruits")
local Toggle = Tabs.Main:AddToggle("Auto Random Bone", { Title = "Auto Random Bone", Default = false })
...
local Cuti = Tabs.Main:AddSection("Farm Boss Server")
local Toggle = Tabs.Main:AddToggle("auto Change", { Title = "Auto Soul Reaper", Description = "", Default = false })
Toggle:OnChanged(function(Value)
_G.Buoi = Value
StopTween(_G.Buoi)
end)         
...
local Toggle = Tabs.item:AddToggle("Start Farm", { Title = "Start Farm Item", Description = "", Default = false })
Toggle:OnChanged(function(Value)
    StartFarm = Value
    StopTween(StartFarm)
end)       
