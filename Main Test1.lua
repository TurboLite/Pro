...
local SelectFastAttackMode = (SelectFastAttackMode or "Siêu Đánh Nhanh")

SelectedFastAttackMode = {"Normal Attack","Fast Attack","Siêu Đánh Nhanh"}
...
local function ChangeModeFastAttack(SelectFastAttackMode)
	...
	elseif SelectFastAttackMode == "Fast Attack" then
		FireCooldown = 0.07
	elseif SelectFastAttackMode == "Siêu Đánh Nhanh" then
		FireCooldown = 0.02
	end
end
...
local Toggle = Tabs.C:AddToggle("MyToggle", {
    Title = "Auto Kill Player",
    Default = _G.Auto_Kill  _Ply
})
...
Tabs.C:AddSection("Section Aimbot") 
...
spawn(function()
    ...
    Toggle = Tabs.C:AddToggle("MyToggle", {Title = "Aimbot Gun", Description = "idk work or not aimbot near player", Default = _G.Aimbot_Gun })
    Toggle:OnChanged(function(Value)
        _G.Aimbot_Gun = Value
        saveSettings()
        end)
...
Toggle = Tabs.C:AddToggle("MyToggle", {Title = "Aimbot Near Player", Description = "nah bro please choose dropdown Select player then turn on aimbot", Default = AimSkillNearest })
...
Toggle = Tabs.C:AddToggle("MyToggle", {Title = "Aimbot All Skills", Default = AimSkillNearest })
    Toggle:OnChanged(function(value)
